...
### Change Classification Terms

**SPEC_CHANGE**: Requested behavior is not documented in approved inception artifacts,
or documented behavior is implemented correctly but user expectation differs.
Requires requirements update and explicit approval before implementation.

**BUG_FIX**: Behavior is documented in approved inception artifacts but implementation
