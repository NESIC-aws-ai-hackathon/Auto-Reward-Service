...
- [ ] If classification == SPEC_CHANGE:
  - Verify `aidlc-docs/inception/requirements/requirements.md` was updated
...
- [ ] If classification == BUG_FIX:
  - Link implementation step to `aidlc-docs/construction/{unit-name}/code/bugfix-record.md`
...
- If user requests changes ("Request Changes"):
  1. **MANDATORY**: Route through `common/workflow-changes.md` Section 0 (Modification Request Classification)
...
- Every modification is classified as SPEC_CHANGE or BUG_FIX before implementation
