...
7. **MANDATORY**: If user chooses "Request Changes", route through `common/workflow-changes.md` Section 0 (Modification Request Classification) BEFORE any code modification. Classify as SPEC_CHANGE or BUG_FIX first.
8. **MANDATORY**: Log user's response in audit.md with complete raw input
