...
MSG_WELCOME = (
    "はじめまして〜🌿 ふれまーるちゃんだよ〜\n"
    "あなたのお財布をのんびり見守りながら、ちゃんと甘やかしも楽しめるようサポートするねぇ\n\n"
    "まずは〜、毎月の手取り収入を教えてくれるかなぁ？（例: 25万、300000）"
)

MSG_ASK_FIXED_COSTS = (
    "ありがとね〜🌿\n次に、毎月かかる固定費を教えてほしいなぁ\n"
    "家賃・スマホ代・サブスクなどをまとめて教えてくれるとうれしい〜🌱\n"
...
MSG_CONFIRM_BUDGET_TEMPLATE = (
    ...
    "これでいい感じかなぁ？（「はい」か「変える」で教えてね〜）"
)

MSG_ASK_BONUS = (
    "了解だよ〜🌿\n"
    "ボーナスはあるかなぁ？（「あり 6月と12月 60万」みたいに教えてもらえるとうれしいな〜）\n"
    "なければ「なし」でOKだよ〜"
)

MSG_ASK_BIRTHDAY = (
    "最後に〜、誕生日を教えてもらえるかなぁ？🌸（例: 8月20日）\n"
    "お誕生日前後にスペシャルなご褒美を提案するよ〜\n"
    "教えたくない場合は「スキップ」でもOKだよ〜🌿"
)

MSG_COMPLETED = (
    "セットアップ完了〜🌿\n"
    "これからふれまーるちゃんがお財布と甘やかしをのんびり一緒に管理するね〜\n"
    "何か買い物したり、疲れたときはいつでも気軽に話しかけてね〜🌱"
)
