...
_FALLBACK_NO_ITEMS: dict[str, str] = {
    "friendly": "うーん、今ちょうどいいご褒美が見つからなかったよ😅 また明日見てみるね！",
    "polite": "現在ご褒美候補が少ない状況です。明日また確認してみてください。",
    "devilish": "今日はピンとくるのがないな〜😏 また明日覗いてみて？",
}

# フォールバックメッセージ（Bedrock 失敗）
_FALLBACK_BEDROCK: dict[str, str] = {
    "friendly": "ちょっとフリーズしちゃった😅 でもご褒美候補は見つかってるよ！また話しかけてね！",
    "polite": "申し訳ありません、少々調子が悪いようです。もう一度お試しください。",
    "devilish": "あら、今日は言葉が出てこないみたい😏 もう一回話しかけて？",
}
...
def propose_reward(
    ...
    Args:
        ...
        tone:          リワードちゃんの口調（friendly / polite / devilish）
